 ...
 */
public class TextColorAttrHandler implements ISkinAttrHandler {

    @Override
    public void apply(View view, SkinAttr skinAttr, ResourceManager resourceManager) {
        if (null == view
                || null == skinAttr
                || !(SkinConstant.SupportTypes.TEXT_COLOR.equals(skinAttr.mAttrName))) {
            return;
        }
        ...
        if (SkinConstant.ResTypes.RES_TYPE_NAME_COLOR.equals(skinAttr.mAttrValueTypeName)
                || SkinConstant.ResTypes.RES_TYPE_NAME_DRAWABLE.equals(skinAttr.mAttrValueTypeName)) {
